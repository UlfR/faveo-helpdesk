                ...
                <div class="col-md-6">
                    <table class="table table-hover"id="refresh">
                      <tr><td><b>Ticket Number: </b></td><div><td>{{$ticket->ticket_number}}</td></div></tr>
                        ...
                        <tr><td><b>Department:</b></td>   <?php $help_topic = App\Model\Manage\Help_topic::where('id', '=', $ticket->help_topic_id)->first();?><td title="{{$help_topic->desc()}}">{{$help_topic->desc()}}</td></tr>
...
?>
                    <table class="table table-hover">
                        ...
                        <tr><td><b>Help Topic:</b></td>     <?php $help_topic = App\Model\Manage\Help_topic::where('id', '=', $ticket->help_topic_id)->first();?><td title="{{$help_topic->desc()}}">{{$help_topic->desc()}}</td></tr>
