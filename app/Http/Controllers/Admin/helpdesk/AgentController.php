...
class AgentController extends Controller
{
    ...
    public function create(Timezones $timezone, Groups $group, Department $department, Teams $team_all, CountryCode $code)
    {
        try {
            ...
            return view('themes.default1.admin.helpdesk.agent.agents.create', compact('assign', 'teams', 'agents', 'timezones', 'groups', 'departments', 'team', 'send_otp', 'org'))->with('phonecode', $phonecode->phonecode);
        } catch (Exception $e) {
