...
class FormController extends Controller
{
    ...
    {
        try {
            $form_extras = $request->except('Name', 'Phone', 'Email', 'Subject', 'Details', 'helptopic', '_wysihtml5_mode', '_token', 'mobile', 'Code', 'priority', 'attachment', 'type_id', 'helptopic_par', 'helptopic_sub');
